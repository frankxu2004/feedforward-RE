...
TEST_MODE = 0
TRAIN_JSON_FILE = 'data/TACRED/train.json'
TRAIN_LABEL_JSON_FILE = 'data/TACRED/train_label.json'
TEST_JSON_FILE = 'data/TACRED/test.json'
TEST_LABEL_JSON_FILE = 'data/TACRED/test_label.json'
GLOVE_FILE = 'data/TACRED/original/glove.6B.100d.txt'
MODEL_WEIGHTS_FILE = 'tacred_model.h5'

none_id = get_none_id('data/TACRED/original/relation2id.txt')
print('None id: ', none_id)
num_classes = get_class_num('data/TACRED/original/relation2id.txt')
