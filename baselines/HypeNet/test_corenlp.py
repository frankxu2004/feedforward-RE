...
document = '''I wonder what the #mail person will say when they sort this tomorrow #yum and #fun via the #USPS ... I ??? http://t.co/APa1inDK4X'''
print('document: {0}'.format(document))

# Parse the text
annotations = get_stanford_annotations(document, annotators='tokenize,ssplit,depparse')
