...
class SPRNNModel(object):
    ...
    def build_graph(self):
        ...
        left_sent_batch, right_sent_batch = tf.split(split_dim=0, num_split=2, value=sent_batch)
        left_seq_lens, right_seq_lens = tf.split(split_dim=0, num_split=2, value=self.seq_lens)
        ...
        final_hidden = tf.concat(1, [left_final_hidden, right_final_hidden], 'final_hidden')
